...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lr', type=float, default=0.0006, help='initial learning rate for adam')
        ...
        self.parser.add_argument('--no_profg', action='store_true', help='do not use shape gradient profile loss')
        self.parser.add_argument('--no_profc', action='store_true', help='do not use color gradient profile loss')
        ...
        self.parser.add_argument('--lambda_profg', type=float, default=1.0, help='weight for shape gradient profile loss')
        self.parser.add_argument('--lambda_profc', type=float, default=1.0, help='weight for shape gradient profile loss')
